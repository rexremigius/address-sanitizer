...
@___asan_gen_ = private constant [7 x i8] c"test.c\00", align 1
@___asan_gen_.1 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.2 = private unnamed_addr constant [7 x i8] c"test.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { [7 x i8]*, i32, i32 } { [7 x i8]* @___asan_gen_.2, i32 6, i32 9 }
...
@0 = internal global [1 x { i64, i64, i64, i64, i64, i64, i64, i64 }] [{ i64, i64, i64, i64, i64, i64, i64, i64 } { i64 ptrtoint ({ [4 x i8], [28 x i8] }* @.str to i64), i64 4, i64 32, i64 ptrtoint ([17 x i8]* @___asan_gen_.1 to i64), i64 ptrtoint ([7 x i8]* @___asan_gen_ to i64), i64 0, i64 ptrtoint ({ [7 x i8]*, i32, i32 }* @___asan_gen_.3 to i64), i64 -1 }]
